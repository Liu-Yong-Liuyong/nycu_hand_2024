...
@app.route('/right-move-1')
def right_1_page():
    # Logic for the right page
    return render_template('righthand_move_1.html')

@app.route('/right-move-2')
def right_2_page():
    # Logic for the right page
    return render_template('righthand_move_2.html')

@app.route('/right-move-3')
def right_3_page():
    # Logic for the right page
    return render_template('righthand_move_3.html')

@app.route('/right-move-4')
def right_4_page():
    # Logic for the right page
    return render_template('righthand_move_4.html')
    
@app.route('/right-move-5')
def right_5_page():
    # Logic for the right page
    return render_template('righthand_move_5.html')

@app.route('/right-move-6')
def right_6_page():
    # Logic for the right page
    return render_template('righthand_move_6.html')

@app.route('/right-move-7')
def right_7_page():
    # Logic for the right page
    return render_template('righthand_move_7.html')

@app.route('/left-move-1')
def left_1_page():
    # Logic for the left page
    return render_template('lefthand_move_1.html')

@app.route('/left-move-2')
def left_2_page():
    # Logic for the left page
    return render_template('lefthand_move_2.html')

@app.route('/left-move-3')
def left_3_page():
    # Logic for the left page
    return render_template('lefthand_move_3.html')

@app.route('/left-move-4')
def left_4_page():
    # Logic for the left page
    return render_template('lefthand_move_4.html')
    
@app.route('/left-move-5')
def left_5_page():
    # Logic for the left page
    return render_template('lefthand_move_5.html')

@app.route('/left-move-6')
def left_6_page():
    # Logic for the left page
    return render_template('lefthand_move_6.html')

@app.route('/left-move-7')
def left_7_page():
    # Logic for the left page
    return render_template('lefthand_move_7.html')
